...
class AttendanceController extends Controller
{
    public function markAttendanceForm() {
        ...
        return Inertia::render('Attendance/Mark', [ // Maps to resources/js/Pages/Attendance/Mark.jsx
            ...
            // Flash messages are automatically available via usePage().props.flash
        ]);
    }
    ...
    public function dashboard(Request $request) {
        ...
        // Get total possible attendance days within the date range.
        ...
        $query = DB::table('attendances')
                    ...
                    ->select(
                        ...
                        DB::raw('COUNT(attendances.id) as total_recorded_attendances') // Total records for the student-subject combo within the range
                    )
        ...
        // Calculate percentage attendance on the collection
